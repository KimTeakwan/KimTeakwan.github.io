...
- <img src="/images/java_icon.png" alt="Java Icon" width="30" height="30"> **Java**: 엔터프라이즈급 애플리케이션 개발에 주로 사용되는 강력한 객체지향 언어입니다.
- <img src="/images/jsp_icon.png" alt="JSP Icon" width="30" height="30"> **JSP (JavaServer Pages)**: Java 기반의 웹 페이지를 동적으로 생성하는 기술입니다.
- <img src="/images/python_icon.png" alt="Python Icon" width="30" height="30"> **Python**: 데이터 분석, 인공지능, 웹 개발 등 다양한 분야에서 활용되는 다재다능한 언어입니다.
